...
for ($i = 1; $i <= 95; $i++)
{
    ...
    if ($bit == 0)
    {
	Imagefilledrectangle ($im, $start, 0, $end, 25, $bg);
    }
    else
    {
	Imagefilledrectangle ($im, $start, 0, $end, 25, $fg);
    }
    $start = $end;
}
...
ImageString ($im, 0, 14, 30, "$c[1] $c[2] $c[3] $c[4] $c[5] $c[6] $c[7] $c[8] $c[9] $c[10] $c[11] $c[12] $c[13]", $fg);
